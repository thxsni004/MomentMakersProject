...
function HinduBrideOrder() {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
          try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/order/hindubride`);
  ...
  return (
    <div >
         ...
         <h2 className="orders-header text-center my-4">Hindu Bride Orders</h2>
         ...
         <thead className="table-header">
             ...
             <tbody className="table-body">
               {orders.length > 0 ? (
                 ...
                 <tr>
                 <td colSpan="12" className="text-center no-orders">
                     No orders available.
                   </td>
                 </tr>
               )}
...
export default HinduBrideOrder
