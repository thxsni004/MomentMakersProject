...
import './Hindubridepack.css';
import './Main.css'
import { useNavigate } from "react-router-dom";
import Breadcrumb from 'react-bootstrap/Breadcrumb';

function Hindubridepack() {
...
const[user,setselecteduser]=useState(()=>{
  ...
  const clearAllSelections = () => {
    ...
    sessionStorage.setItem("orderHistory", JSON.stringify(orderHistory));
        ...
        try {
          const response = await fetch(`${import.meta.env.VITE_API_URL}/bridepack`, {
            method: 'POST',
            headers: {
  ...
  const calculateGrandTotal = () => {
    ...
    console.log('Stages fetched:', stages);
     ...
     useEffect(() => {
                            ...
                            console.log('packages fetched:', add);
