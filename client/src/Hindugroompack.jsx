...
const[user,setselecteduser]=useState(()=>{
  ...
  const clearAllSelections = () => {
    ...
    // const stageOptions = [
    //   { id: "middle", name: "Middle Class Stage", price: 20000, image:"hindupack/stage2.jpg" },
    //   { id: "upperMiddle", name: "Upper Middle Class Stage", price: 60000,image:"hindupack/stage1.jpg"  },
    //   { id: "high", name: "High Class Stage", price: 200000,image:"hindupack/stage.jpg"  },
    // ];
    ...
    sessionStorage.setItem("orderHistory", JSON.stringify(orderHistory));
      ...
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/groompack`, {
          method: 'POST',
          headers: {
  ...
  // Fetch Addoptions from the backend
          useEffect(() => {
   ...
   <Breadcrumb className="custom-breadcrumb">
        ...
        <Breadcrumb.Item href="/hindu">🔙 </Breadcrumb.Item>
      </Breadcrumb>
      <h2>Food Packages</h2>
